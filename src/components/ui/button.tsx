  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // MessEase custom variants
        hero: "bg-gradient-to-r from-primary to-primary/80 text-primary-foreground shadow-lg hover:shadow-xl hover:shadow-primary/25 active:scale-[0.98] hover:-translate-y-0.5",
        ...
        poll: "bg-accent text-accent-foreground border-2 border-transparent hover:border-primary/30 hover:bg-accent/80",
        pollActive: "bg-primary text-primary-foreground shadow-md",
      },
      size: {
